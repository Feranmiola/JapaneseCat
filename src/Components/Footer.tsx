...
const Footer = () => (
    <>
        <div className="bg-tokenomicsBg h-[686px] xl:h-[800px] 2xl:h-[1000px] 5xl:h-[1200px] w-full max-lg:hidden">
            <div className="flex items-center pt-28 2xl:pt-[20rem] justify-center h-full">
