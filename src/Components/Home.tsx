const Home = () => {
    return (
        <div className="w-screen max-sm:h-[900px] bg-white h-[1152px] md:h-[820px] lg:h-[1100px] 2xl:h-[1800px] xl:h-[1300px] 4xl:h-[2400px]">
            ...
            <div className="relative w-full pt-10 max-sm:pt-[14rem] max-lg:pt-[8rem]">
                <div className="md:absolute w-full flex md:justify-between max-md:items-end max-md:justify-end ">
                    ...
                    <img src="./assets/catRight.svg" className="md:relative max-sm:absolute max-md:left-[12rem] max-md:top-[2rem] max-md:bottom-[12rem] max-lg:h-[304px] max-lg:w-[199.84px]  4xl:bottom-[8rem] 3xl:w-[720px] 3xl:bottom-[13rem] 3xl:h-[786px] max-lg:bottom-[10rem] max-sm:bottom-[6.5rem] bottom-56 md:bottom-40 lg:bottom-60 xl:bottom-[13rem] 2xl:bottom-[5rem] 5xl:bottom-[3rem]" />
                </div>
