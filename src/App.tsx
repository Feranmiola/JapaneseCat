...
function App() {
  ...
  return (
    <div className='flex flex-col items-center justify-center'>
      <div className='flex w-full max-w-[684px] max-sm:max-w-[310px] max-sm:max-h-[64px] h-[80px] bg-white items-center shadow-custom-normal rounded-[24px] justify-center fixed top-5 z-50 mx-2 md:mx-auto'>
